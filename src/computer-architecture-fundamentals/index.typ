...
The goal of this chapter is to equip you---the reader---with foundational knowledge required to understand the discussions within this thesis and to establish common terminology.

#{
  include "./computer-architecture-fundamentals.typ"
